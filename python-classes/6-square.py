...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Raises:
            TypeError: If the size is not an integer, or position is not a tuple of two positive integers.
            ValueError: If the size is less than 0, or position contains negative integers.
